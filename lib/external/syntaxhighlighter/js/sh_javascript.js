...
sh_languages['javascript'] = [
  [
	...
	[
		/\b(?:define|ifdef|endif)\b/g,
	  'sh_function',
      -1
	],
    [
      /\b(?:abstract|set|text1|text2|text3|text4|text5|text6|p|h1|h2|h3|h4|h5|h6|img|list|circle|template|setup|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|false|final|finally|for|function|goto|if|implements|in|instanceof|interface|native|new|null|private|protected|prototype|public|return|static|super|switch|synchronized|throw|throws|this|transient|true|try|typeof|var|volatile|while|with)\b/g,
      'sh_keyword',
      -1
    ],
    [
